...
weekdays = ([last_monday + datetime.timedelta(days=i) for i in range(0 - last_monday.weekday(), 7 - last_monday.weekday())])
print(last_monday)
...
#model=load_model(reviews_sentiment.h5’)



#if not st.sidebar.checkbox('type_review',False):
    #st.markdown("Enter the new review")
    #message = st.text_area(“Enter Review”,”Type Here ..”)
    #spacy_cleaner(message)
